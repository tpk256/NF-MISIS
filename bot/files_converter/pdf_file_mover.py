...
def pdf_mover():
	...
	files = glob.glob(r'C:\Users\tpk25\Downloads\pdf_files\*')
	for file in files:
		try:
			os.remove(file)
	...
	path_destination = r'C:\Users\tpk25\Downloads\pdf_files'
	files_xls = glob.glob(r'C:\Users\tpk25\Downloads\xls_files\*.xls')
